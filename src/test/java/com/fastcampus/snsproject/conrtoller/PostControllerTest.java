...
class PostControllerTest {
    ...
    @Test
    @WithAnonymousUser
    void 포스트삭제시_로그인하지_않는_경우() throws Exception{
        mockMvc.perform(delete("/api/v1/posts/1")
                        .contentType(MediaType.APPLICATION_JSON)
                ).andDo(print())
                .andExpect(status().isUnauthorized());
    ...
    @Test
    @WithAnonymousUser
    void 피드목록시_로그인하지_않는_경우() throws Exception{
    ...
    @Test
    @WithAnonymousUser
    void 내피드목록시_로그인하지_않는_경우() throws Exception{
    ...
    @Test
    @WithAnonymousUser
    void 좋아요버튼_클릭시_로그인하지_않는_경우() throws Exception{
        mockMvc.perform(post("/api/v1/posts/1/likes")
                        .contentType(MediaType.APPLICATION_JSON)
                ).andDo(print())
                .andExpect(status().isUnauthorized());
    ...
    @Test
    @WithAnonymousUser
    void 댓글작성시_로그인하지_않는_경우() throws Exception{
        mockMvc.perform(post("/api/v1/posts/1/comments")
                        .contentType(MediaType.APPLICATION_JSON)
                ).andDo(print())
                .andExpect(status().isUnauthorized());
